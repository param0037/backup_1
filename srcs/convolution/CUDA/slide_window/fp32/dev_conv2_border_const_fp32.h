...
//#include "conv2_border_ignored.h"
...
namespace decx
{
    ...
    */
    static void _dev_Conv2_BC_R8x8(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R8x16(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R16x8(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_BC_R16x16(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH* handle);



    static void dev_sConv2_border_zero(decx::_GPU_Matrix<float>& src, decx::_GPU_Matrix<float>& kernel, decx::_GPU_Matrix<float>& dst, de::DH* handle);
}
...
static
void decx::_dev_Conv2_BC_R8x8(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_dev_Conv2_BC_R8x16(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_dev_Conv2_BC_R16x8(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_dev_Conv2_BC_R16x16(decx::_GPU_Matrix<float>* src, decx::_GPU_Matrix<float>* kernel, decx::_GPU_Matrix<float>* dst, de::DH *handle)
{
    float4* Dsrc,
        * Ddst;
...
static 
void decx::dev_sConv2_border_zero(decx::_GPU_Matrix<float>& src, decx::_GPU_Matrix<float>& kernel, decx::_GPU_Matrix<float>& dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _dev_Conv2_BC_R8x8(&src, &kernel, &dst, handle);
        }
        else {
            _dev_Conv2_BC_R16x8(&src, &kernel, &dst, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _dev_Conv2_BC_R8x16(&src, &kernel, &dst, handle);
        }
        else {
            _dev_Conv2_BC_R16x16(&src, &kernel, &dst, handle);
        }
    }
    decx::Success(handle);
}
