...
namespace decx
{
    ...
    */
    static void _Conv2_NB_R8x8(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R16x16(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R8x16(decx::_Matrix<float>* src, decx::_Matrix<float>* kernel, decx::_Matrix<float>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_NB_R16x8(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle);


    static void sConv2_border_ignore(decx::_Matrix<float>& src, decx::_Matrix<float>& kernel, decx::_Matrix<float>& dst, de::DH* handle);
}



static void decx::_Conv2_NB_R8x8(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_Conv2_NB_R16x16(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_Conv2_NB_R8x16(decx::_Matrix<float>* src, decx::_Matrix<float>* kernel, decx::_Matrix<float>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_Conv2_NB_R16x8(_Matrix<float>* src, _Matrix<float>* kernel, _Matrix<float>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::sConv2_border_ignore(decx::_Matrix<float>& src, decx::_Matrix<float>& kernel, decx::_Matrix<float>& dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_NB_R8x8(&src, &kernel, &dst, handle);
        }
        else {
            _Conv2_NB_R16x8(&src, &kernel, &dst, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_NB_R8x16(&src, &kernel, &dst, handle);
        }
        else {
            _Conv2_NB_R16x16(&src, &kernel, &dst, handle);
        }
    }
    decx::Success(handle);
}
