...
namespace decx
{
    ...
    static void main_loop_sconv2_mk_within8x16_NB(int2* Dsrc_alloc_dim, int2* Ddst_alloc_dim, int2* ker_dim,
        _MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst,
        MIF<float4>* Dmem1, MIF<float4>* Dmem2, MIF<float4>* Dmem3, MIF<float4>* Dmem4,
        decx::cuda_stream* S[3]);
    ...
    // single kernel
    static void _Conv2_NB_R8x8_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_NB_R8x16_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_NB_R16x8_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_NB_R16x16_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst);


    static void sConv2_border_ignore_mk(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst, de::DH* handle);
}
...
// single kernel
static void decx::_Conv2_NB_R8x8_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst)
{
...
// single kernel
static void decx::_Conv2_NB_R8x16_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst)
{
...
// single kernel
static void decx::_Conv2_NB_R16x8_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_NB_R16x16_MK(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::sConv2_border_ignore_mk(_MatrixArray<float>* src, decx::_MatrixArray<float>* kernel, _MatrixArray<float>* dst, de::DH* handle)
{
    int2 half_ker_dim;
