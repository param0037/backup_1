...
namespace decx
{
    ...
    // single kernel
    static void _Conv2_BC_R8x8_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_BC_R8x16_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_BC_R16x8_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst);


    // single kernel
    static void _Conv2_BC_R16x16_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst);


    static void sConv2_border_zero_sk(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst, de::DH* handle);
}
    ...
    decx::cuda_stream* S[3])
{
    ...
    main_loop_regulable_R_sk(
        sconv2_kernel_within8x8(Dmem1->mem, Dmem3->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_within8x8(Dmem2->mem, Dmem4->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_exact8x8(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_exact8x8(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        conv3_main_loop_MemCpyHtoD_BC(bounded_kernel_R8, bounded_kernel_R8, float, 4),
        float);
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_within8x16(Dmem1->mem, Dmem3->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_within8x16(Dmem2->mem, Dmem4->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_exact8x16(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_exact8x16(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        conv3_main_loop_MemCpyHtoD_BC(bounded_kernel_R8, bounded_kernel_R16, float, 4),
        float);
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_within16x8(Dmem1->mem, Dmem3->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_within16x8(Dmem2->mem, Dmem4->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_exact16x8(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_exact16x8(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        conv3_main_loop_MemCpyHtoD_BC(bounded_kernel_R16, bounded_kernel_R8, float, 4),
        float);
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_within16x16(Dmem1->mem, Dmem3->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_within16x16(Dmem2->mem, Dmem4->mem, src_diff, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
    ...
    decx::cuda_stream* S[3])
{
    ...
    // strat the main loop
    main_loop_regulable_R_sk(
        sconv2_kernel_exact16x16(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        sconv2_kernel_exact16x16(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, S[0]->get_raw_stream_ptr()),
        conv3_main_loop_MemCpyHtoD_BC(bounded_kernel_R16, bounded_kernel_R16, float, 4),
        float);
...
// single kernel
static void decx::_Conv2_BC_R8x8_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst)
{
...
// single kernel
static void decx::_Conv2_BC_R8x16_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x8_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x16_SK(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::sConv2_border_zero_sk(_MatrixArray<float>* src, _Matrix<float>* kernel, _MatrixArray<float>* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_BC_R8x8_SK(src, kernel, dst);
        }
        else {
            _Conv2_BC_R16x8_SK(src, kernel, dst);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_BC_R8x16_SK(src, kernel, dst);
        }
        else {
            _Conv2_BC_R16x16_SK(src, kernel, dst);
        }
    }
}
