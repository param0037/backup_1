...
namespace decx
{
    ...
    // single kernel
    static void dev_Conv2_BC_R8x8_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst);


    // single kernel
    static void dev_Conv2_BC_R8x16_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst);


    // single kernel
    static void dev_Conv2_BC_R16x8_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst);


    // single kernel
    static void dev_Conv2_BC_R16x16_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst);


    static void dev_sConv2_border_zero_sk(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst, de::DH* handle);
}
...
// single kernel
static void decx::dev_Conv2_BC_R8x8_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
...
// single kernel
static void decx::dev_Conv2_BC_R8x16_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst)
{
    int2 Dsrc_alloc_dim,
        Ddst_alloc_dim,
        ker_dim;
...
// single kernel
static void decx::dev_Conv2_BC_R16x8_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst)
{
...
// single kernel
static void decx::dev_Conv2_BC_R16x16_SK(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::dev_sConv2_border_zero_sk(_GPU_MatrixArray<float>* src, _GPU_Matrix<float>* kernel, _GPU_MatrixArray<float>* dst, de::DH* handle)
{
    int2 half_ker_dim;
