...
namespace decx
{
    ...
    // single kernel
    static void _Conv2_BC_R8x8_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst);


    // single kernel
    static void _Conv2_BC_R8x16_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst);


    // single kernel
    static void _Conv2_BC_R16x8_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst);


    // single kernel
    static void _Conv2_BC_R16x16_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst);


    static void hConv2_border_zero_mk(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst, de::DH* handle);
}
    ...
    decx::cuda_stream* S[3])
{
    ...
    main_loop_regulable_R_mk(
        decx::hconv2_kernel_exact8x16_offset(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0]->get_raw_stream_ptr()),
        decx::hconv2_kernel_exact8x16_offset(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), S[0]->get_raw_stream_ptr()),
        conv3_main_loop_MemCpyHtoD_BC_MK(bounded_kernel_R8, bounded_kernel_R16, de::Half, 8),
        de::Half);
...
// single kernel
static void decx::_Conv2_BC_R8x8_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst)
{
...
// single kernel
static void decx::_Conv2_BC_R8x16_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x8_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
// single kernel
static void decx::_Conv2_BC_R16x16_MK_fp16(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst)
{
    MIF<float4> Dmem1, Dmem2,    // for src
        Dmem3, Dmem4;            // for dst
...
static void decx::hConv2_border_zero_mk(_MatrixArray<de::Half>* src, _MatrixArray<de::Half>* kernel, _MatrixArray<de::Half>* dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_BC_R8x8_MK_fp16(src, kernel, dst);
        }
        else {
            decx::_Conv2_BC_R16x8_MK_fp16(src, kernel, dst);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_Conv2_BC_R8x16_MK_fp16(src, kernel, dst);
        }
        else {
            decx::_Conv2_BC_R16x16_MK_fp16(src, kernel, dst);
        }
    }
}
