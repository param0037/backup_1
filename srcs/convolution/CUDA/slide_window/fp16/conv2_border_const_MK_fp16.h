        ...
        cudaStream_t S[3])
{
    ...
    main_loop_regulable_R_mk(
        decx::hconv2_kernel_exact8x16_offset(Dmem1->mem, Dmem3->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), &S[0]),
        decx::hconv2_kernel_exact8x16_offset(Dmem2->mem, Dmem4->mem, *Dsrc_alloc_dim, *Ddst_alloc_dim, *ker_dim, sym_cpy_offset / sizeof(de::Half), &S[0]),
        conv3_main_loop_MemCpyHtoD_BC_MK(bounded_kernel_R8, bounded_kernel_R16, de::Half, 8),
        de::Half);
