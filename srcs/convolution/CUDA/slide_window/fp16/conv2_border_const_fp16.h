...
namespace decx
{
    ...
    */
    static void _Conv2_BC_R8x8_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_BC_R16x8_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_BC_R8x16_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _Conv2_BC_R16x16_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH* handle);


    static void hConv2_border_zero(_Matrix<de::Half>& src, _Matrix<de::Half>& kernel, _Matrix<de::Half>& dst, de::DH* handle);
}



static
void decx::_Conv2_BC_R8x8_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH *handle)
{
    float4* Dsrc,
        * Ddst;
...
static
void decx::_Conv2_BC_R16x8_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_Conv2_BC_R8x16_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH *handle)
{
    float4* Dsrc,
        *Ddst;
...
static
void decx::_Conv2_BC_R16x16_fp16(_Matrix<de::Half>* src, _Matrix<de::Half>* kernel, _Matrix<de::Half>* dst, de::DH *handle)
{
    float4* Dsrc,
        * Ddst;
...
static 
void decx::hConv2_border_zero(_Matrix<de::Half>& src, _Matrix<de::Half>& kernel, _Matrix<de::Half>& dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_BC_R8x8_fp16(&src, &kernel, &dst, handle);
        }
        else {
            _Conv2_BC_R16x8_fp16(&src, &kernel, &dst, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            _Conv2_BC_R8x16_fp16(&src, &kernel, &dst, handle);
        }
        else {
            _Conv2_BC_R16x16_fp16(&src, &kernel, &dst, handle);
        }
    }
}
