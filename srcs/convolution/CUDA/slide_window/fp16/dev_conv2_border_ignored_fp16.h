...
namespace decx
{
    ...
    */
    static void _dev_Conv2_NB_R8x8_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R16x16_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R8x16_fp16(decx::_GPU_Matrix<de::Half>* src, decx::_GPU_Matrix<de::Half>* kernel, decx::_GPU_Matrix<de::Half>* dst, de::DH* handle);
    ...
    * In order to save the device memory, just allocate memory of suitable size
    */
    static void _dev_Conv2_NB_R16x8_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle);



    static void dev_hConv2_border_ignore(decx::_GPU_Matrix<de::Half>& src, decx::_GPU_Matrix<de::Half>& kernel, decx::_GPU_Matrix<de::Half>& dst, de::DH* handle);
}




static void decx::_dev_Conv2_NB_R8x8_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R16x16_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R8x16_fp16(decx::_GPU_Matrix<de::Half>* src, decx::_GPU_Matrix<de::Half>* kernel, decx::_GPU_Matrix<de::Half>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::_dev_Conv2_NB_R16x8_fp16(_GPU_Matrix<de::Half>* src, _GPU_Matrix<de::Half>* kernel, _GPU_Matrix<de::Half>* dst, de::DH* handle)
{
    float4* Dsrc,
        * Ddst;
...
static void decx::dev_hConv2_border_ignore(decx::_GPU_Matrix<de::Half>& src, decx::_GPU_Matrix<de::Half>& kernel, decx::_GPU_Matrix<de::Half>& dst, de::DH* handle)
{
    int2 half_ker_dim;
    ...
    if (half_ker_dim.x < bounded_kernel_R8 + 1) {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_dev_Conv2_NB_R8x8_fp16(&src, &kernel, &dst, handle);
        }
        else {
            decx::_dev_Conv2_NB_R16x8_fp16(&src, &kernel, &dst, handle);
        }
    }
    else {
        if (half_ker_dim.y < bounded_kernel_R8 + 1) {
            decx::_dev_Conv2_NB_R8x16_fp16(&src, &kernel, &dst, handle);
        }
        else {
            decx::_dev_Conv2_NB_R16x16_fp16(&src, &kernel, &dst, handle);
        }
    }
}
