...
namespace de
{
    namespace nn
    {
        _DECX_API_ de::DH max_pooling_f(_FLOAT_& src, _FLOAT_& dst, const de::Point2D scale);


        _DECX_API_ de::DH max_pooling_f_recorded(_FLOAT_& src, _FLOAT_& dst, _INT_& index_map, const de::Point2D scale);
...
de::DH de::nn::max_pooling_f(_FLOAT_& src, _FLOAT_& dst, const de::Point2D scale)
{
    de::DH handle;
    decx::Success(&handle);
...
de::DH de::nn::max_pooling_f_recorded(_FLOAT_& src, _FLOAT_& dst, _INT_ &index_map, const de::Point2D scale)
{
    de::DH handle;
    decx::Success(&handle);
