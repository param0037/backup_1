...
de::DH de::fft::FFT1D_R2C_f(de::Vector<float>& src, de::Vector<de::CPf>& dst)
{
    de::DH handle;
...
de::DH de::fft::FFT1D_C2C_f(de::Vector<de::CPf>& src, de::Vector<de::CPf>& dst)
{
    de::DH handle;
