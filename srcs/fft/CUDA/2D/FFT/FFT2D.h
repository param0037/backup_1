...
de::DH de::fft::FFT2D_R2C_f(de::Matrix<float>& src, de::Matrix<de::CPf>& dst)
{
    de::DH handle;
...
de::DH de::fft::FFT2D_C2C_f(de::Matrix<de::CPf>& src, de::Matrix<de::CPf>& dst)
{
    de::DH handle;
