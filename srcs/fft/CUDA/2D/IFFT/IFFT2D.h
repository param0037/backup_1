...
de::DH de::fft::IFFT2D_C2R_f(de::Matrix<de::CPf>& src, de::Matrix<float>& dst)
{
    de::DH handle;
...
de::DH de::fft::IFFT2D_C2C_f(de::Matrix<de::CPf>& src, de::Matrix<de::CPf>& dst)
{
    de::DH handle;
